# Test wrapper: warp-aware residual roulette at 24 lanes (HANDOFF_9 5 redesign,
...
#   _WARP_RR_LANES = 24 -> aggressive threshold; rouletttes residual paths
#     whenever a warp is <24/32 occupied - biggest occupancy gain but the most
#     kills, so the most likely to fail the gate.
