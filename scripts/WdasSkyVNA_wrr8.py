# Test wrapper: warp-aware residual roulette at 8 lanes (HANDOFF_9 5 redesign,
...
#   _WARP_RR_LANES = 8 -> conservative threshold; only rouletttes residual paths
#     when a warp is already <8/32 occupied.
